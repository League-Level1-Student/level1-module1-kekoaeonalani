...
public class TurfWar extends PApplet {
    ...
    class Player {
        ...
        Player(int x, int y, int speed, int playerSize, int playerColor, int upKey, int downKey, int leftKey, int rightKey){
        	this.x = x;
        	this.y = y;
        	this.speed = speed;
   ...
   Player player2;
    ...
    public void setup() {
         ...
         */
        player1 = new Player(200, 200, 15,50, Color.WHITE.getRGB(),UP,DOWN,LEFT,RIGHT);
        player2 = new Player(100,200, 15, 50, Color.RED.getRGB(),W,S,A,D );
