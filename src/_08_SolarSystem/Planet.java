...
public class Planet {
    ...
    public Planet(int diameterPixels, String planetColor, int distanceFromTheSun, int orbitalPeriod) {
    ...
    public void draw(Graphics g, int numDays) {
         ...
         */
        int avgDistFromSun = distanceFromTheSun / 10;     // You can choose a different scaling than divided by 10
